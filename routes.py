...
def register_routes(app):
    ...
    def manage_food():
        ...
        food_data = sql_reader.read_data(
            "SELECT * FROM food_eaten ORDER BY timestamp DESC"
        )
    ...
    def manage_bodyweight():
        sql_reader = SQLite3Reader("data/bodyweight.db")
        bodyweight_data = sql_reader.read_data(
            "SELECT * FROM bodyweight ORDER BY date DESC"
        )
